        ...
        <div class="row" > 
           ...
           <p class="text-justify pl-2">
            ...
            <div class="col-sm-12 mt-5" >
                <div class="card" >
                   <div class="col-sm-12">
                   <div class="card-header glyphicon glyphicon-menu-down " @click="hidePanel = !hidePanel" >
                            <span >DEFEAT YOUR OPPONENT</span>
                    </div
                   </div>
                    
                    <div class="card-body"  v-show="hidePanel" >
                            <p class="text-justify pl-2"> Each player starts the game with 20 life. Knock your opponent down to 0 life, and you win. The most common way to do this is to summon creatures and attack with them.
                               <br><br>    
